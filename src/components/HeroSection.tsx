      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-up delay-200">
            ...
            receive best practices, and strengthen your security posture in real-time. All for free.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-up delay-300">
            <Link
              to="/learn"
              className="group flex items-center gap-3 px-10 py-5 bg-primary text-primary-foreground rounded-xl font-bold text-xl md:text-2xl hover:bg-primary/90 transition-all duration-300 shadow-glow hover:shadow-glow-lg hover:scale-105"
            >
            ...
            <button
              onClick={onOpenChat}
              className="group flex items-center gap-3 px-8 py-4 border border-border hover:border-primary/50 rounded-xl font-semibold text-lg hover:bg-secondary/50 transition-all duration-300 hover:scale-105"
            >
