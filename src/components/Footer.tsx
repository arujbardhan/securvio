import securvioBanner from "@/assets/securvio-footer-banner.png";
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-2 mt-6">
              ...
              <span className="text-xs text-muted-foreground font-mono">SECURE • PROTECT • DEFEND</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 pt-4">
                <div className="w-8 h-8 rounded-lg bg-card border border-border/50 flex items-center justify-center hover:border-primary/50 transition-colors cursor-pointer">
